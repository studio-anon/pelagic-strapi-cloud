...
export interface ApiGlobalSettingGlobalSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site-wide settings and social links';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerButtons: Schema.Attribute.Component<'shared.external-link', true> &
    ...
    termsSlug: Schema.Attribute.UID;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage content with dynamic sections';
...
export interface ApiJournalArticleJournalArticle
  extends Struct.CollectionTypeSchema {
